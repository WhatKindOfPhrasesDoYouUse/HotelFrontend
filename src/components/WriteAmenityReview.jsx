...
const WriteAmenityReview = () => {
    const { bookingId, amenityId } = useParams();
    ...
    const handleSubmit = async (e) => {
        ...
        if (!bookingId) {
            setError("ID бронирования услуги не найдено");
            setSubmitting(false);
            return;
        }

        if (!amenityId) {
            setError("ID услуги не найдено");
            setSubmitting(false);
            return;
        }
        ...
        try {
            const payload = {
                ...
                amenityBookingId: parseInt(bookingId),
            ...
            <div style={{
                ...
                <div className="auth-container" style={{
                    ...
                    <div className="auth-header" style={{
                        ...
                        <p style={{ opacity: '0.9', fontSize: '0.95rem' }}>Поделитесь своим мнением о нашей услуге</p>
                    </div>
        ...
        <div style={{
            ...
            <div className="auth-container" style={{
                ...
                <div className="auth-footer" style={{
                    ...
                    Спасибо за ваш отзыв! <a href="/amenities" style={{
                    color: '#4a6bff',
                    textDecoration: 'none',
                    fontWeight: '600'
                }}><FaHome /> Вернуться к услугам</a>
                </div>
            </div>
        </div>
    );
...
export default WriteAmenityReview;