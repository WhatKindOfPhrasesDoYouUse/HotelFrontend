...
const PaymentTypeAdministration = () => {
    ...
    useEffect(() => {
        const fetchPaymentTypes = async () => {
            ...
            try {
                ...
                const response = await axios.get('http://localhost:5221/api/payment-types');
    ...
    const handleDelete = async (paymentTypeId) => {
        const confirmDelete = window.confirm(`Вы действительно хотите удалить тип отеля с ID ${paymentTypeId}?`);
        if (!confirmDelete) return;

        try {
            const token = localStorage.getItem('token');
            await axios.delete(`http://localhost:5221/api/payment-types/${paymentTypeId}`, {
                headers: {
    ...
    return (
        <div className="container">
            ...
            <div className="header">
                ...
                <h1>Управление типами оплаты</h1>
            </div>
            ...
            {paymentTypes.length > 0 ? (
                <div className="card">
                        ...
                        <table>
                            ...
                            {paymentTypes.map((paymentType) => (
                                <tr key={paymentType.id}>
                                    ...
                                    <td className="hotel-name">{paymentType.name}</td>
                                    <td className="actions-cell">
                                        <div className="actions">
                                            ...
                                            <button
                                                onClick={() => navigate(`/edit-payment-type/${paymentType.id}`)}
                                                style={{
                    ...
                    <div style={{textAlign: 'right'}}>
                        <button onClick={() => navigate('/add-payment-type')}
...
export default PaymentTypeAdministration;