...
const EmployeeTypeAdministration = () => {
    ...
    useEffect(() => {
        const fetchEmployeeTypes = async () => {
            ...
            try {
                ...
                const response = await axios.get('http://localhost:5221/api/employee-types');
    ...
    const handleDelete = async (employeeTypeId) => {
        const confirmDelete = window.confirm(`Вы действительно хотите удалить тип отеля с ID ${employeeTypeId}?`);
        if (!confirmDelete) return;

        try {
            await axios.delete(`http://localhost:5221/api/employee-types/${employeeTypeId}`);

            setEmployeeTypes(prev => prev.filter(ht => ht.id !== employeeTypeId));
            setSuccess(true);
    ...
    return (
        <div className="container">
            ...
            <div className="header">
                ...
                <h1>Управление типами сотрудников</h1>
            </div>
            ...
            {employeeTypes.length > 0 ? (
                <div className="card">
                        ...
                        <table>
                            ...
                            {employeeTypes.map((employeeType) => (
                                <tr key={employeeType.id}>
                                    ...
                                    <td className="hotel-name">{employeeType.name}</td>
                                    <td className="actions-cell">
                                        ...
                                        <div className="actions">
                                            ...
                                            <button
                                                onClick={() => navigate(`/edit-employee-type/${employeeType.id}`)}
                                                style={{
                    ...
                    <div style={{textAlign: 'right'}}>
                        <button onClick={() => navigate('/add-employee-type')}
                ...
                <div className="no-data">Нет данных о типах оплаты</div>
            )}
...
export default EmployeeTypeAdministration;